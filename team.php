...
/**
* Plugin Name:     AO Team
* Description:     A plugin creates Team custom post type
* version:         1.0.0
...
class Team {
   ...
   // Represents the nonce value used to save the post media
	 private $nonce = 'wp_team_nonce';
	 private $singular_label = "Team Member";
	 private $plural_label = "Team";
    ...
    wp_enqueue_script( 'team-meta-js', plugins_url( 'js/index.js', __FILE__ ), array('jquery'), T_VERSION);
